...
export function Footer() {
  ...
  return (
    <footer className="bg-primary px-8 py-4 text-text-primary">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4">
        ...
        <p className="text-xs leading-snug text-text-primary/80">
          <Link to="/terms" className="text-text-primary/80 no-underline hover:text-white">Términos y condiciones</Link>
          &nbsp;·&nbsp;
          <Link to="/privacy" className="text-text-primary/80 no-underline hover:text-white">Política de privacidad</Link>
        </p>
      </div>
    </footer>
  );
