...
const STEPS = [
  ...
  { label: "Contacto y seguridad", subtitle: "Teléfono y contraseña" },
...
export function InvitedRegisterPage() {
  ...
  const isStepComplete = (s: number): boolean => {
    ...
    if (s === 1) {
      ...
      return formData.phone.trim() !== "" && pwdOk &&
  ...
  if (loadingInvitation) {
    return (
      <AuthLayout headerActionLabel="Iniciar sesión" headerActionTo="/login">
        <div className="text-center text-text-secondary">Cargando invitación...</div>
      </AuthLayout>
    );
  }
    ...
    return (
      <AuthLayout headerActionLabel="Iniciar sesión" headerActionTo="/login">
        <div className="flex w-full max-w-md flex-col items-center rounded-2xl bg-surface p-8 shadow-lg">
          ...
          <h2 className="mb-2 text-lg font-bold text-text-primary">Invitación no válida</h2>
    ...
    return (
      <AuthLayout headerActionLabel="Iniciar sesión" headerActionTo="/login">
        <div className="flex w-full max-w-md flex-col items-center rounded-2xl bg-surface p-8 shadow-lg">
          ...
          <h2 className="mb-2 text-lg font-bold text-text-primary">¡Registro exitoso!</h2>
          <p className="mb-4 text-center text-sm text-text-secondary">
    ...
    <AuthLayout headerActionLabel="Iniciar sesión" headerActionTo="/login">
      <div className="flex w-full max-w-[620px] flex-col overflow-hidden rounded-2xl bg-surface shadow-lg">
        <div className="px-7 py-5">
          ...
          <p className="mb-3 text-sm text-text-secondary">Completa tus datos para unirte a la finca</p>
          ...
          <form onSubmit={handleSubmit} noValidate
              ...
              <>
                <div className="mb-2 grid grid-cols-1 gap-2.5 sm:grid-cols-2">
                  <div className="flex flex-col">
                    ...
                    <input id="firstName" name="firstName" type="text" placeholder="Ingrese sus nombres" value={formData.firstName} onChange={handleChange} className="rounded-lg border-[1.5px] border-border bg-surface px-2.5 py-1.5 text-sm text-text-primary outline-none transition-colors placeholder:text-text-muted focus:border-primary focus:ring-2 focus:ring-primary/10" />
                  ...
                  <div className="flex flex-col">
                    ...
                    <input id="lastName" name="lastName" type="text" placeholder="Ingrese sus apellidos" value={formData.lastName} onChange={handleChange} className="rounded-lg border-[1.5px] border-border bg-surface px-2.5 py-1.5 text-sm text-text-primary outline-none transition-colors placeholder:text-text-muted focus:border-primary focus:ring-2 focus:ring-primary/10" />
                ...
                <div className="mb-2 grid grid-cols-1 gap-2.5 sm:grid-cols-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <input id="documentNumber" name="documentNumber" type="text" placeholder="Ingrese su número" value={formData.documentNumber} onChange={handleChange} className="rounded-lg border-[1.5px] border-border bg-surface px-2.5 py-1.5 text-sm text-text-primary outline-none transition-colors placeholder:text-text-muted focus:border-primary focus:ring-2 focus:ring-primary/10" />
              ...
              <>
                <div className="mb-2">
                  <div className="flex flex-col">
                    ...
                    <input id="phone" name="phone" type="tel" placeholder="+57 300 123 4567" value={formData.phone} onChange={handleChange} className="rounded-lg border-[1.5px] border-border bg-surface px-2.5 py-1.5 text-sm text-text-primary outline-none transition-colors placeholder:text-text-muted focus:border-primary focus:ring-2 focus:ring-primary/10" />
            ...
            <div className="mt-4 flex gap-2">
              ...
              {step < STEPS.length - 1 ? (
                <button key="paso-siguiente" type="button" onClick={nextStep} disabled={!isStepComplete(step)} className="flex-1 rounded-lg bg-primary px-4 py-2 text-sm font-bold text-white hover:bg-primary-light transition-colors disabled:cursor-not-allowed disabled:opacity-50">Siguiente →</button>
              ) : (
