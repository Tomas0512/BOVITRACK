...
class Farm(Base):
    __tablename__ = "farm"
    __table_args__ = (UniqueConstraint("name", "department_id", "city_id", name="uq_farm_name_location"),)
    ...
    city_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("city.id", ondelete="SET NULL"), nullable=True)
